...
export function TournamentForm({mode, tournamentId, onSuccess}: TournamentFormProps) {
  ...
  return (
    <Card className="max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl">{mode === "create" ? "Create New Tournament" : "Edit Tournament"}</CardTitle>
        <CardDescription>
          {mode === "create" ? "Fill in the details to create a new tournament." : "Update tournament details."}
        </CardDescription>
      </CardHeader>
      <Form {...form}>
